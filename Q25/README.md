...
Utilize C++ STL if needed. Write a C++ program to solve the following,
Polycarp was presented with some sequence of integers a of length n (1a; n). A sequence can make Polycarp happy only if it consists of different numbers (i.e. distinct numbers).
